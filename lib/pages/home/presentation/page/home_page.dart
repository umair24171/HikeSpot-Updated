              ...
              children: [
                ...
                if (_menueCubit.userState == AppState.user)
                  AnimatedPositioned(
                    ...
                    bottom: state is RidingSectionHide ? -getHeight(context) * 0.4 : 0,
                    left: 0,
                    right: 0,
                  ...
                  builder: (context, state) {
                    return AnimatedPositioned(
                      ...
                      bottom: state is RidingSectionHide
                          ? 30
                          : getHeight(context) * 0.43 + _ridingSectionCubit.locationButtonGap,
                      right: 20,
                ...
                // 🔥 DRIVER BUTTONS - COMPLETELY REWRITTEN FOR RELIABILITY
                if (_menueCubit.userState == AppState.captain)
                  StreamBuilder<QuerySnapshot>(
                    stream: FirebaseFirestore.instance
                        ...
                        .snapshots(),
                    builder: (context, snapshot) {
                      // No active ride - show captain working sheet
                      if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                      ...
                      if (activeRide.rideStatus == 'Running') {
                        ...
                        // Auto-update map to show route to pickup
                      ...
                      // 🔥 CASE 2: Arrived at pickup, waiting for passenger (Arrived)
                      ...
                      // 🔥 CASE 3: Going to destination (start_destination) - FINISH RIDE BUTTON
                      else if (activeRide.rideStatus == 'start_destination') {
                        print("🎯 Showing 'Finish Ride' button");
                        
                        // Auto-update map to show route to destination
                        WidgetsBinding.instance.addPostFrameCallback((_) {
                          if (_googleMapCubit.isArrived != 1) {
                            _googleMapCubit.getPolyPoint(
                              activeRide.destinationLatitude,
